...
df=pd.read_csv('Csv-all-Datasets\spaceX.2006.csv',parse_dates=['Launch Date'])
...
plt.savefig( r"Final Assessement Part-1(ML)\SpaceX_2006 _Industry_Analytics\image\mission_outcome_distribution.png",
    dpi=300,
    bbox_inches="tight"
)
plt.show()
...
plt.savefig(r"Final Assessement Part-1(ML)\SpaceX_2006 _Industry_Analytics\image\launches_per_year.png",dpi=300,
            bbox_inches="tight")
plt.show()
...
sns.scatterplot(x=df['Launch Date'].dt.year,
                ...
                hue='Mission Outcome',
                data=df)
plt.savefig(r"Final Assessement Part-1(ML)\SpaceX_2006 _Industry_Analytics\image\payload_mass_vs_launch_year.png",dpi=300,
            bbox_inches="tight")
plt.show()
...
plt.savefig(r"Final Assessement Part-1(ML)\SpaceX_2006 _Industry_Analytics\image\vehicle_distribution.png",dpi=300,
            bbox_inches="tight")
plt.show()
...
plt.savefig(r"Final Assessement Part-1(ML)\SpaceX_2006 _Industry_Analytics\image\payload_type_distribution.png",dpi=300,
            bbox_inches="tight")
plt.show() 
...
plt.savefig(r"Final Assessement Part-1(ML)\SpaceX_2006 _Industry_Analytics\image\payload_mass_by_outcome.png",dpi=300,
            bbox_inches="tight")
plt.show()
...
plt.savefig(r"Final Assessement Part-1(ML)\SpaceX_2006 _Industry_Analytics\image\kde_plot.png",
...
plt.savefig(r"Final Assessement Part-1(ML)\SpaceX_2006 _Industry_Analytics\image\swarm_plot.png",
            dpi=300,bbox_inches="tight")
plt.show()
...
plt.savefig(r"Final Assessement Part-1(ML)\SpaceX_2006 _Industry_Analytics\image\violin_plot.png",
            dpi=300,bbox_inches="tight")
plt.show()
...
plt.savefig(r"Final Assessement Part-1(ML)\SpaceX_2006 _Industry_Analytics\image\correlation_heatmap.png",dpi=300,
            bbox_inches="tight")
plt.show()
#---------- FEATURE SELECTION ----------
X = df[
...
plt.savefig(
    r"Final Assessement Part-1(ML)\SpaceX_2006 _Industry_Analytics\image\feature_importance.png",
    dpi=300,
    bbox_inches="tight"
)
plt.show()
...
plt.savefig(r"Final Assessement Part-1(ML)\SpaceX_2006 _Industry_Analytics\image\model_accuracy_comparison.png",
            dpi=300,
            bbox_inches="tight")
plt.show()
