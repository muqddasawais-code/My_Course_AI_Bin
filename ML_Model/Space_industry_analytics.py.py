...
numeric_cols = ["Launches","Successful","Failed","Revenue_USD_M","Budget_Funding_USD_M","Employees","Rockets","Success_Rate_%"]

#_______Pair Plot__________

sns.pairplot(df[numeric_cols],diag_kind='kde')
plt.show() 
sns.pairplot(df,vars=["Launches","Budget_Funding_USD_M","Employees","Rockets","Revenue_USD_M"])     #hue="Company",diag_kind="kde")#It may BREAK relation
