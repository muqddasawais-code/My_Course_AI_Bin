...
ids, price , long , lat = np.genfromtxt('CSV-All-Datasets\zameencom-property-data-By-Kaggle-Short.csv', delimiter=';', usecols=(0,4,8,9), unpack=True, dtype=None,skip_header=1)
